...
please download these default files [here](https://github.com/wastl-junior/ethermint/tree/develop/setup).
...
See the [open issues](https://github.com/wastl-junior/ethermint/issues) for
